...
const FROM = process.env.EMAIL_FROM || 'DocuRAG: AI Q&A for Internal Knowledge Bases <noreply@example.com>';
const APP_NAME = 'DocuRAG: AI Q&A for Internal Knowledge Bases';
