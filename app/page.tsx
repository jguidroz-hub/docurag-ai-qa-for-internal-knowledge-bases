  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="max-w-4xl mx-auto px-6 py-20 text-center">
        <h1 className="text-4xl md:text-5xl font-bold mb-4">DocuRAG: AI Q&A for Internal Knowledge Bases</h1>
        <p className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto">Value Proposition: For IT/HR departments & internal support teams, provides an instant, accurate Q&A interface over scattered internal documentation (wikis, Confluence, shared drives). Reduces search time, improves employee self-service & onboarding efficiency.
...
Promotion Type: automatic</p>
      ...
      <section className="max-w-4xl mx-auto px-6 py-20 text-center">
        ...
        <p className="text-gray-600 mb-6">Join thousands of small businesses who trust DocuRAG: AI Q&A for Internal Knowledge Bases.</p>
      ...
      <footer className="border-t py-8">
        <div className="max-w-4xl mx-auto px-6 flex justify-between text-sm text-gray-500">
          <p>© {new Date().getFullYear()} DocuRAG: AI Q&A for Internal Knowledge Bases. All rights reserved.</p>
